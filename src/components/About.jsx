    ...
    < >
      ...
      <section id="about" className="py-10">
        ...
        <div className="2xl:container mt-16 patternabout ">
          ...
          <a href="https://www.linkedin.com/in/anirudh-b-01a088222?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="blank">
            ...
            <div className="bg-[#160E39]  bg-opacity-[85%] flex flex-col items-center justify-evenly gap-y-6 rounded-3xl w-[280px] h-[362px] md:w-[309px] md:h-[400px] border-[#CCCCCC] border-[2px] border-opacity-[50%] relative pt-6">
            <a href="https://www.linkedin.com/in/kavirajar?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="blank">
            <div className=" absolute  top-3 right-3">
                <svg
                  data-name="Layer 1"
                  viewBox="0 0 24 24"
